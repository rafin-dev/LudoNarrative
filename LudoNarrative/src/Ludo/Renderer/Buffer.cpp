...
namespace Ludo {
    ...
    Ref<VertexBuffer> VertexBuffer::Create(uint32_t size, const BufferLayout& layout)
    {
        ...
        case RendererAPI::API::DirectX12: return CreateRef<DirectX12VertexBuffer>(size, layout);
        }
    ...
    Ref<VertexBuffer> VertexBuffer::Create(float* vertices, uint32_t size, const BufferLayout& layout)
    {
        switch (Renderer::GetAPI())
        {
            ...
            case RendererAPI::API::DirectX12: return CreateRef<DirectX12VertexBuffer>(vertices, size, layout);
        }
